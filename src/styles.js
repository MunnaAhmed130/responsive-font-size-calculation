const styles = {
    ...
    heading2: "xs:text-2xl text-2xl font-black pt-8",
    ...
    input: "caret-slate-300 text-slate-400 w-full font-semibold text-center py-1 tracking-widest text-2xl focus:text-sky-300",
    error: "text-sm text-red-600 font-medium bg-orange-0",
    button: "font-semibold bg-slate-100 text-slate-400 rounded transition shadow-lg shadow-slate-200",
    buttonHover:
        "hover:bg-slate-300 hover:text-slate-700 hover:shadow-slate-200",
